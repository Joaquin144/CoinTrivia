...
import com.joaquin.quizapp.cointrivia.databinding.ActivitySpinnerBinding;
import com.joaquin.quizapp.cointrivia.model.LuckyItem;
import com.joaquin.quizapp.cointrivia.utils.Constants;
import com.joaquin.quizapp.cointrivia.views.LuckyWheelView;
...
public class SpinnerActivity extends AppCompatActivity {
    ...
    private void updateCash(int index) {
        ...
        database.collection(Constants.FS_USERS_COLLECTION).document(FirebaseAuth.getInstance().getUid()).update("coins", FieldValue.increment(cash)).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
