package com.joaquin.quizapp.cointrivia.views;
...
import com.joaquin.quizapp.cointrivia.model.LuckyItem;
import com.joaquin.quizapp.cointrivia.utils.LuckyWheelUtil;
...
public class LuckyWheelView extends RelativeLayout implements PielView.PieRotateListener {
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mTopTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwTopTextSize, (int) LuckyWheelUtil.convertDpToPixel(25f, getContext()));
            mSecondaryTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwSecondaryTextSize, (int) LuckyWheelUtil.convertDpToPixel(10f, getContext()));
            mTextColor = typedArray.getColor(R.styleable.LuckyWheelView_lkwTopTextColor, 0);
            mTopTextPadding = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwTopTextPadding, (int) LuckyWheelUtil.convertDpToPixel(22f, getContext())) + (int) LuckyWheelUtil.convertDpToPixel(15f, getContext());
